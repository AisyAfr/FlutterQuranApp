...
import 'package:quran_app_flutter/tabs/doa_tab.dart';
import 'package:quran_app_flutter/tabs/dzikr_tab.dart';
import 'package:quran_app_flutter/tabs/surah_tab.dart';
          ...
          headerSliverBuilder:
              (BuildContext context, bool innnerBoxIsScrolled) => [
                    ...
                    SliverAppBar(
                      ...
                      shape: Border(
                          bottom: BorderSide(
                              width: 3, color: secondary.withOpacity(0.1))),
